  ...
  return (
    <div className="mx-auto max-w-md space-y-6 py-12">
      <div className="space-y-2 text-center">
        <h1 className="text-6xl font-extrabold">Bedrock Token Estimator</h1>
      ...
      <form className="space-y-4">
        ...
        <div className="grid gap-2">
          <Label htmlFor="cost" className="mb-6">Estimated Token Input Cost for {totalTokens} tokens</Label>
